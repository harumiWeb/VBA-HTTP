...
Public Const WinHttpRedirectPolicyNever As Long = 0
Public Const WinHttpRedirectPolicyDisallowHttpsToHttp As Long = 1
Public Const WinHttpRedirectPolicyAlways As Long = 2
...
Public Const WinHttpOptionDecompression As Long = 118
Public Const WinHttpProtocolFlagHttp2 As Long = 1
Public Const WinHttpProtocolFlagHttp3 As Long = 2
Public Const WinHttpDecompressionFlagGzip As Long = 1
Public Const WinHttpDecompressionFlagDeflate As Long = 2
Public Const WinHttpDecompressionFlagAll As Long = 3
